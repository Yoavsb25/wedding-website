export const site = {
  ...
  gifts: {
    ...
    quickPay: [
      ...
      { id: 'maya-paybox', label: "Maya's PayBox", app: 'paybox', url: 'https://links.payboxapp.com/Lo4zjkKfp3b' },
      { id: 'yoav-paybox', label: "Yoav's PayBox", app: 'paybox', url: 'https://links.payboxapp.com/T3Q4VsOfp3b' },
    ],
  },
};
